...
const downloader_1 = __webpack_require__(45);
async function activate(context) {
    ...
    if (!bin) {
        ...
        if (ret === 0) {
            try {
                const latest = await downloader_1.getLatestRelease(ctx.config.channel);
                if (!latest)
                    throw new Error('Failed to get latest release');
                await downloader_1.downloadServer(context, latest);
            }
            catch (e) {
                console.error(e);
...
const ctx_1 = __webpack_require__(36);
const ra = __importStar(__webpack_require__(70));
let terminal;
...
class Ctx {
    constructor(extCtx) {
        ...
        this.updater = new inlay_hints_1.HintsUpdater(this);
    ...
    async checkUpdate(auto = true) {
        ...
        if (ret === 0) {
            ...
            try {
                await downloader_1.downloadServer(this.extCtx, latest);
            }
            catch (e) {
                console.error(e);
...
class Config {
    constructor() {
        ...
        this.requiresReloadOpts = ['serverPath', 'cargo', 'procMacro', 'files', 'updates', 'lens', 'hoverActions', 'inlayHints'].map((opt) => `${this.rootSection}.${opt}`);
...
const crypto_1 = __webpack_require__(18);
const fs_1 = __webpack_require__(2);
const https_proxy_agent_1 = __webpack_require__(46);
const node_fetch_1 = __importDefault(__webpack_require__(64));
const os_1 = __importDefault(__webpack_require__(17));
const path_1 = __importDefault(__webpack_require__(16));
const stream_1 = __importDefault(__webpack_require__(65));
const util_1 = __importDefault(__webpack_require__(57));
...
async function downloadServer(context, release) {
    ...
    statusItem.show();
    // @ts-ignore
    const resp = await node_fetch_1.default(release.url, { agent });
    ...
    const _path = path_1.default.join(context.storagePath, release.name);
    const randomHex = crypto_1.randomBytes(5).toString('hex');
    const tempFile = path_1.default.join(context.storagePath, `${release.name}${randomHex}`);
...
const agent_1 = __importDefault(__webpack_require__(47));
...
const tls_1 = __importDefault(__webpack_require__(48));
const url_1 = __importDefault(__webpack_require__(49));
const assert_1 = __importDefault(__webpack_require__(50));
const debug_1 = __importDefault(__webpack_require__(51));
const agent_base_1 = __webpack_require__(60);
const parse_proxy_response_1 = __importDefault(__webpack_require__(63));
...
try {
	...
	const supportsColor = __webpack_require__(58);
...
const debug_1 = __importDefault(__webpack_require__(51));
const promisify_1 = __importDefault(__webpack_require__(62));
...
/* harmony export */ });
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(65);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67);
